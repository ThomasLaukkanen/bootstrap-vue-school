<template>
  <footer class="bg-primary text-light">
    ...
    <b-nav align="center" class="mb-2">
      <b-nav-item to="/Om" link-classes="text-light"
        >Om Göteborgarna.se</b-nav-item
      >
      ...
      <b-nav-item link-classes="text-light">Open Source</b-nav-item>
    </b-nav>
  </footer>
</template>
